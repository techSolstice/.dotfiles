...
sudo dnf install -y steam spotify-client vim calibre arc-theme gnome-tweak-tool powerline-fonts zsh qbittorrent shutter php meld google-chrome docker docker-compose f26-backgrounds-animated composer php-pecl-xdebug wget screenfetch
